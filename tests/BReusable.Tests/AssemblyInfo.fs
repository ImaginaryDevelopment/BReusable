...
[<assembly: AssemblyTitleAttribute("BReusable.Tests")>]
[<assembly: AssemblyProductAttribute("BReusable")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "BReusable.Tests"
    let [<Literal>] AssemblyProduct = "BReusable"
