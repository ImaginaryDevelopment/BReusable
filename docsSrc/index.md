...
BReusable is a library of useful code I've accumulated over my years of coding.

## Why use BReusable?

It is tested and centralized into a single file for lots of uses.
...
<div class="row row-cols-1 row-cols-md-2">
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-footer text-right   border-top-0">
        <a href="{{siteBaseUrl}}/Api_Reference/BReusable/BReusable.html" class="btn btn-primary">Read Api Docs</a>
      </div>
    </div>
  </div>
</div>
